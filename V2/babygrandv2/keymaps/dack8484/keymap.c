...
enum combos { CORNERS_PWR, JQUOTE_ENT };
...
combo_t key_combos[COMBO_COUNT] = {[CORNERS_PWR] = COMBO(corners_combo, KC_PWR), [JQUOTE_ENT] = COMBO(jquote_combo, KC_ENT)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [CLOSE] = LAYOUT_alpha_3x10(
    ...
    _______, _______, vvv,     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,  _______,
         RESET,   _______, KC_MPLY,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
                               KC_VOLD, KC_VOLU
  )
};
